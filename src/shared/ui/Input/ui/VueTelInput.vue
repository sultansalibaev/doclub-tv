    ...
    <div :class="['vue-tel-input relative', styleClasses, { disabled: disabled }]">
        ...
        >
            ...
            <ul
                ...
                @click.stop
                ref="list"
                class="vti__dropdown-list rounded-[12px] mt-[8px]"
            ...
            >
                ...
                <div class="text-400 overflow-y-scroll max-h-[172px] gray-scrollbar pr-[5px] !cursor-default" style="border-right: 5px solid transparent;">
                    <li
                        ...
                        tabindex="-1"
                        @click="choose(pb);toggleDropdown();"
                    ...
                    >
                        ...
                        <span class="truncate" :title="pb.name">{{ pb.name }}</span>
...
export default {
    ...
    data() {
        let defaultCountryValue =  this.allCountries.find((country) => country.dialCode === (this.defaultCountry.toString() ?? "971"));
        return {
            phone: '',
            activeCountryCode: defaultCountryValue?.iso2 ?? '',
    ...
    computed: {
        ...
        phoneObject() {
            ...
            if (valid) {
                ...
                if (phoneObject?.countryCallingCode == '7') formatted = formatted.slice(1).trim()
            }
    ...
    mounted() {
        ...
        this.cleanInvalidCharacters(); // country-changed activeCountry 
